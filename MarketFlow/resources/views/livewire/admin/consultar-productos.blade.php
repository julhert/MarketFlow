            ...
            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)]">
                ...
                <div class="flex justify-center items-center gap-4 mb-8">
                    ...
                    <a href="{{ route('productos.crear') ?? '#' }}"
                        ...
                        <svg xmlns="http://www.w3.org/2001/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <tr class="hover:bg-brand-blue-50/30 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                @if ($item->activo == 'Activo' || $item->activo === 1)
                                                    <span class="bg-btn-success/10 text-btn-success px-4 py-1 rounded-full text-xs font-bold uppercase border border-btn-success/20">
                                                        Activo
                                                    </span>
                                                @else
                                                    <span class="bg-btn-danger/10 text-btn-danger px-4 py-1 rounded-full text-xs font-bold uppercase border border-btn-danger/20">
                                                        Inactivo
                                                    </span>
                                                @endif
                                            </td>
                                            <td class="px-6 py-4">
                                                <div class="flex justify-center gap-3">
                                                    <a href="{{ route('productos.modificar', $item->id ?? $item->id_producto) ?? '#' }}" wire:navigate
                                                    ...
                                                    <button wire:click="eliminar({{ $item->id ?? $item->id_producto }})"
                                                        wire:confirm="¿Estás seguro que quieres eliminar este producto?"
