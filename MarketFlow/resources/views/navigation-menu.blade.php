<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        {{-- EJEMPLO SPATIE: Visible SOLO para Vendedores --}}
                        @role('vendedor')
                        ...
                        {{-- EJEMPLO SPATIE: Visible SOLO para Administradores --}}
                        @role('admin')
                            <x-nav-link href="#" :active="false">
                                <x-heroicon-o-tag class="w-5 h-5 me-2" />
                                Categorías
                            </x-nav-link>
                        @endrole
                    @endauth
            ...
            {{-- BLOQUE DERECHO: Perfil de Usuario (Escritorio) --}}
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                {{-- EJEMPLO SPATIE: Vendedores (Móvil) --}}
                @role('vendedor')
