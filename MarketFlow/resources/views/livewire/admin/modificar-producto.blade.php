    ...
    <main class="flex-1 flex flex-col overflow-hidden bg-[#F4F6F9]">
        <div class="flex-1 overflow-y-auto p-10">
            ...
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-xl border border-brand-blue-100 overflow-hidden">
                ...
                <form wire:submit.prevent="editar" class="p-8">
                    <div class="grid grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block font-body text-brand-blue-300 font-bold mb-1">Stock Disponible</label>
                        ...
                        <div class="flex flex-col items-center justify-center border-2 border-dashed border-brand-blue-100 rounded-2xl p-4 bg-gray-50">
                            ...
                            @if ($imagen)
                                <img src="{{ $imagen->temporaryUrl() }}" class="w-48 h-48 object-cover rounded-xl shadow-md mb-4 border border-brand-blue-100">
                                <p class="text-xs text-brand-blue-400 font-bold mb-2">Nueva imagen lista para guardar</p>
                            @elseif ($imagen_actual)
                                <img src="{{ asset('storage/' . $imagen_actual) }}" class="w-48 h-48 object-cover rounded-xl shadow-md mb-4 border border-gray-200">
                                <p class="text-xs text-gray-500 font-bold mb-2">Imagen actual</p>
                            @else
                                <div class="w-48 h-48 bg-gray-200 rounded-xl flex items-center justify-center mb-4 border border-gray-300">
                                    <svg class="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                </div>
                            @endif

                            <input type="file" wire:model="imagen" id="upload" class="hidden">
                            <label for="upload" class="cursor-pointer bg-brand-blue-100 text-[#274472] px-4 py-2 rounded-lg font-bold hover:bg-brand-blue-200 transition-all text-sm">
                                Cambiar imagen
                            </label>
